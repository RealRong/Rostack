import { createDerivedStore, type ReadStore } from '@/runtime/store'
import type { InteractionState } from '@/react/page/interaction'
import type { CurrentView } from '@/react/view'
