    ...
    renderPanel: ({
      ...
      return (
        <EdgeMarkerPanel
          ...
          onChange={(value) => {
            if (side === 'start') {
              editor.actions.document.edge.style.start(edge.edgeIds, value)
              return
            }

            editor.actions.document.edge.style.end(edge.edgeIds, value)
          }}
        />
      )
    }
  ...
  renderPanel: ({
    ...
    return (
      <EdgeStrokePanel
        ...
        opacity={edge.opacity}
        onColorChange={(value) => {
          editor.actions.document.edge.style.color(edge.edgeIds, value)
        }}
        onOpacityChange={(value) => {
          editor.actions.document.edge.style.opacity(edge.edgeIds, value)
        }}
      />
    )
  }
  ...
  renderPanel: ({
    ...
    return (
      <EdgeGeometryPanel
        ...
        width={edge.width}
        onTypeChange={(value) => {
          editor.actions.document.edge.type.set(edge.edgeIds, value)
        }}
        onDashChange={(value) => {
          editor.actions.document.edge.style.dash(edge.edgeIds, value)
        }}
        onWidthChange={(value) => {
          editor.actions.document.edge.style.width(edge.edgeIds, value)
        }}
      />
    )
  }
...
const edgeMarkerSwapItem: ToolbarItemSpec = {
  ...
  renderButton: ({
    ...
    return (
      <ToolbarIconButton
        onClick={() => {
          editor.actions.document.edge.style.swapMarkers(edge.edgeIds)
        }}
        title="Swap markers"
      ...
      <ToolbarIconButton
        onClick={() => {
          if (edge.primaryEdgeId) {
            editor.actions.document.edge.label.add(edge.primaryEdgeId)
          }
        }}
        title="Add label"
  ...
  renderButton: ({
    ...
    return (
      <ToolbarIconButton
        ...
        onClick={() => {
          editor.actions.document.edge.textMode.set(edge.edgeIds, nextTextMode)
        }}
