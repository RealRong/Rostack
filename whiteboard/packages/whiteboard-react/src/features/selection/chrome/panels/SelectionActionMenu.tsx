...
export const SelectionActionMenu = ({
  ...
  const target = useStoreValue(editor.scene.editor.selection)
  const nodeStats = useStoreValue(editor.scene.selection.node.stats)
  const summary = useStoreValue(editor.scene.selection.view).summary
